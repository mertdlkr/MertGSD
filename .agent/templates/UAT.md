...
- This section feeds directly into /nexgsd-plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /nexgsd-plan-phase --gaps with root causes
...
**Creation:** When /nexgsd-verify-work starts new session
