...
The user may provide a platform and/or environment, e.g., `/gsd-deploy vercel`, `/gsd-deploy cf-pages`, `/gsd-deploy netlify --preview`
...
- "Deploy failed. See error above. Fix the issue and run /gsd-deploy again."
...
/gsd-verify [N]      -> Run UAT on deployed version
/gsd-audit           -> Run full audit on live site
```
